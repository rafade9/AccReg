...
public class ExecuteQuery extends org.datacontract.schemas._2004._07.wcfreferencemanager.ExecuteValidate
    ...
    public boolean isQueryTypeSpecified() {
        return localQueryTypeTracker;
    }
     ...
     */
    public void setQueryType(java.lang.String param) {
        localQueryTypeTracker = true;

        this.localQueryType = param;
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", namespacePrefix + ":ExecuteQuery", xmlWriter);
        } else {
            writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance",
                "type", "ExecuteQuery", xmlWriter);
        }
        ...
        if (localQueryTypeTracker) {
            namespace = "http://schemas.datacontract.org/2004/07/WCFReferenceManager";
            writeStartElement(null, namespace, "QueryType", xmlWriter);
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localQueryTypeTracker) {
            ...
            elementList.add((localQueryType == null) ? null
                                                     : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localQueryType));
        }
        ...
        public static ExecuteQuery parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ExecuteQuery".equals(type)) {
                            ...
                            return (ExecuteQuery) org.tempuri.imports.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://schemas.datacontract.org/2004/07/WCFReferenceManager",
                            "QueryType").equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if (!"true".equals(nillableValue) &&
                        ...
                        object.setQueryType(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                content));
                    } else {
                        reader.getElementText(); // throw away text nodes if any.
                    }
