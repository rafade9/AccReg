/**
 * BankAccountContractID_V1Content.java
 *
...
/**
 *  BankAccountContractID_V1Content bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class BankAccountContractID_V1Content implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://compartamos.com/common/gdt",
            "BankAccountContractID_V1.Content", "ns1");

    /**
     * field for BankAccountContractID_V1Content
     */
    protected org.apache.axis2.databinding.types.Token localBankAccountContractID_V1Content;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":BankAccountContractID_V1.Content",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "BankAccountContractID_V1.Content", xmlWriter);
            }
        }
    ...
    public static class Factory {
        public static BankAccountContractID_V1Content fromString(
            java.lang.String value, java.lang.String namespaceURI) {
            BankAccountContractID_V1Content returnValue = new BankAccountContractID_V1Content();
        ...
        public static BankAccountContractID_V1Content fromString(
            ...
            if (content.indexOf(":") > -1) {
                ...
                return BankAccountContractID_V1Content.Factory.fromString(content,
                    namespaceUri);
            } else {
                return BankAccountContractID_V1Content.Factory.fromString(content,
                    "");
         ...
         */
        public static BankAccountContractID_V1Content parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            BankAccountContractID_V1Content object = new BankAccountContractID_V1Content();
