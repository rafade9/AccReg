...
/**
 *  ReferenceAttributeData bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ReferenceAttributeData implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ReferenceAttributeData
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ReferenceAttributeData", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
         ...
         */
        public static ReferenceAttributeData parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ReferenceAttributeData object = new ReferenceAttributeData();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ReferenceAttributeData".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ReferenceAttributeData) org.tempuri.imports.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    if (!"true".equals(nillableValue) &&
                        ...
                        object.setAttributeValue(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                content));
                    } else {
                        reader.getElementText(); // throw away text nodes if any.
                    }
