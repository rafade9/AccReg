...
/**
 *  ContactPerson bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ContactPerson implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ContactPerson", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localInternalIDTracker) {
            ...
            elementList.add((localInternalID == null) ? null
                                                      : org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                    localInternalID));
        }
    ...
    public static class Factory {
         ...
         */
        public static ContactPerson parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ContactPerson".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ContactPerson) org.tempuri.imports.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://schemas.datacontract.org/2004/07/WCFReferenceManager",
                            "InternalID").equals(reader.getName())) {
                    ...
                    if (!"true".equals(nillableValue) &&
                        ...
                        object.setInternalID(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                                content));
                    } else {
