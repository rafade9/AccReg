...
public class Date implements org.apache.axis2.databinding.ADBBean {
    ...
    public void setDate(java.util.Date param) {
        if (Util.convertToString(param).matches("[0-9]{4}-[0-9]{2}-[0-9]{2}")) {
    ...
    public java.lang.String toString() {
        return Util.convertToString(localDate);
    }
