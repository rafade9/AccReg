...
/**
 *  ExchangeLogData bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ExchangeLogData implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = ExchangeLogData
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ExchangeLogData", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ExchangeLogData", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ExchangeLogData parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ExchangeLogData object = new ExchangeLogData();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ExchangeLogData".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ExchangeLogData) com.compartamos.global.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
