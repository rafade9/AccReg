/**
 * ZBankCardContractIDContent.java
 *
...
/**
 *  ZBankCardContractIDContent bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ZBankCardContractIDContent implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://compartamos.com/common/gdt",
            "ZBankCardContractID.Content", "ns1");

    /**
     * field for ZBankCardContractIDContent
     */
    protected org.apache.axis2.databinding.types.Token localZBankCardContractIDContent;
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ZBankCardContractID.Content", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ZBankCardContractID.Content", xmlWriter);
            }
        }
    ...
    public static class Factory {
        public static ZBankCardContractIDContent fromString(
            java.lang.String value, java.lang.String namespaceURI) {
            ZBankCardContractIDContent returnValue = new ZBankCardContractIDContent();
        ...
        public static ZBankCardContractIDContent fromString(
            ...
            if (content.indexOf(":") > -1) {
                ...
                return ZBankCardContractIDContent.Factory.fromString(content,
                    namespaceUri);
            } else {
                return ZBankCardContractIDContent.Factory.fromString(content, "");
            }
         ...
         */
        public static ZBankCardContractIDContent parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ZBankCardContractIDContent object = new ZBankCardContractIDContent();
